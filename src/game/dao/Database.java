...
public class Database {
	 ...
	 */
	public static void main(String[] args) throws RecordNotFoundException, SQLException, DuplicateIDException{
	Database db = new Database();
	//Client cl = new Client("teresa", "2323", "em", Client.IMAGE1);
	//System.out.println(db.userExist("monica")); exist 테스트
	//db.addUser(cl); Test
	
	//getAllUser 테스트
//	ArrayList<Client> cuslist = db.getAllUser();
//	for(Client cl1 : cuslist){
//		System.out.println(cl1.toString());
//	}
// saveMessage 테스트
	//	ClientMessage cm = new ClientMessage("monica", "teresa", "Did you eat lunch?");
//	System.out.println(db.saveMessage(cm)); 
	//getAllMessages Test
//	ArrayList<ClientMessage> cml = db.getAllMessages("monica");
//	System.out.println(cml);
	//addFriend Test
	//Friend fr = new Friend("monica", "gopachini");
	//db.addFriend(fr);
	//getAllfriends Test
	//System.out.println(db.getFriendList("monica"));
	}
}
